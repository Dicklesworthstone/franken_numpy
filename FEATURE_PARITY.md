...
1. Expanded Python package surface beyond `nditer`, `frompyfunc`, `vectorize`, `digitize`, `searchsorted`, `interp`, `where`, `flatnonzero`, `argwhere`, `count_nonzero`, `isposinf`, `isneginf`, `signbit`, `isnan`, `isinf`, `isfinite`, `spacing`, `sign`, `floor`, `ceil`, `trunc`, `rint`, `degrees`, `radians`, `sinc`, `copysign`, `nextafter`, `hypot`, `ldexp`, `logaddexp`, `logaddexp2`, `frexp`, `modf`, `nan_to_num`, `take`, `put`, `take_along_axis`, `put_along_axis`, `compress`, `extract`, `place`, `putmask`, `split`, `array_split`, `hsplit`, `vsplit`, `dsplit`, `vstack`, `hstack`, `dstack`, `column_stack`, `indices`, `diag`, `diagflat`, `diagonal`, `fill_diagonal`, `ix_`, `meshgrid`, `mgrid`, `ogrid`, `r_`, `c_`, `ravel_multi_index`, `unravel_index`, `diag_indices`, `diag_indices_from`, `tril_indices`, `tril_indices_from`, `triu_indices`, `triu_indices_from`, `select`, and `choose` — `fnp-python` now exposes `PyNditer`, `frompyfunc`, `vectorize`, `digitize`, `searchsorted`, `interp`, `where`, `flatnonzero`, `argwhere`, `count_nonzero`, `isposinf`, `isneginf`, `signbit`, `isnan`, `isinf`, `isfinite`, `spacing`, `sign`, `floor`, `ceil`, `trunc`, `rint`, `degrees`, `radians`, `sinc`, `copysign`, `nextafter`, `hypot`, `ldexp`, `logaddexp`, `logaddexp2`, `frexp`, `modf`, `nan_to_num`, `take`, `put`, `take_along_axis`, `put_along_axis`, `compress`, `extract`, `place`, `putmask`, `split`, `array_split`, `hsplit`, `vsplit`, `dsplit`, `vstack`, `hstack`, `dstack`, `column_stack`, `indices`, `diag`, `diagflat`, `diagonal`, `fill_diagonal`, `ix_`, `meshgrid`, `mgrid`, `ogrid`, `r_`, `c_`, `ravel_multi_index`, `unravel_index`, `diag_indices`, `diag_indices_from`, `tril_indices`, `tril_indices_from`, `triu_indices`, `triu_indices_from`, `select`, and `choose`, but broader Python-facing packaging and FFI coverage for additional NumPy APIs is still incomplete
